...
for ev_n in evs:
    ...
    #spline 
    spline, u = make_splprep([spl_pts[:, 0], spl_pts[:, 1], spl_pts[:, 2]], s=20, w=clamp_weights)
...
np.savez('muon_0-1gev_1k_gampix.npz', naive = naive_lengths, detailed=detailed_lengths, charge=charge_collected, evs=evs)
